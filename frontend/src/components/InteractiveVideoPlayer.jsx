...
function InteractiveVideoPlayer({
  ...
  return (
    <div className={`flex flex-col min-h-0 ${className}`}>
      ...
      <div
        ref={containerRef}
        className={`relative w-full bg-slate-900 overflow-hidden flex-1 min-h-0 ${
          embedded ? 'rounded-xl ring-1 ring-black/10' : 'rounded-2xl shadow-lg aspect-video ring-1 ring-black/5'
      ...
      <div className={`bg-slate-900 rounded-2xl px-4 py-3 space-y-2 shrink-0 ${embedded ? 'mt-2' : 'mt-4'}`}>
        <div
          ref={progressBarRef}
